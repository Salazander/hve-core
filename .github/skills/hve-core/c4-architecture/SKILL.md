...
license: MIT
user-invocable: true
compatibility: "Works in any chat context where the caller needs architecture diagrams from code or description."
metadata:
  authors: "microsoft/hve-core"
  spec_version: "1.0"
  last_updated: 2026-08-11
  content_based_on: "https://c4model.com/"
---
...
| Diagram                 | Generated by default   | Answers                                                       |
|-------------------------|------------------------|---------------------------------------------------------------|
| Level 1: System Context | Yes                    | Who uses the system and what does it interact with            |
| Level 2: Container      | Yes                    | What separately deployable or runnable units make up a system |
| Level 3: Component      | Yes                    | What major building blocks sit inside one container           |
| Level 4: Code           | On request only        | How one component maps to code structures                     |
| Deployment              | Offered when evidenced | Where container instances run in one named environment        |
...
4. Identify which diagrams are required. Ask the user to clarify what systems and levels to model if unclear from context.
5. Before responding, validate each diagram rule by rule against the selected renderer reference and correct every violation.
